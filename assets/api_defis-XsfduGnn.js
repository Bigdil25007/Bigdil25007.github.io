...
`,image:"/projets/api_defis/mongodb.jpg?url"},{subtitle:"Organisation du projet",paragraph:`Pour la partie base de données **(BdD)**, nous sommes passés par MongoDB Compass pour facilement ajouter des données et les visualiser pour vérifier leur intégrité tout du long du développement.
...
`,image:"/projets/api_defis/middleware.png?url"},{subtitle:"Point technique : Gestion d'erreur",paragraph:`Pour essayer d'avoir une API la plus proche de la réalité, nous avons pris le temps de gérer les erreurs en renseignant les bons codes en fonction de la situation. 
...
`,image:"/projets/api_defis/testRequest.jpg?url"},{subtitle:"Retour d'expérience et points d'amélioration",paragraph:`J'ai bien aimé faire ce projet puisque c'était la première fois que je créais une API. J'ai ainsi découvert MongoDB et ses avantages comme l'accès plus facile aux données pour des requêtes simples (comparé aux requêtes SQL).  
...
`,image:""}],competences:[{techniques:[{skill:"MongoDB",value:90},{skill:"Curl",value:85},{skill:"ExpressJS",value:80},{skill:"Git",value:70}]},{concepts:[{skill:"Requêtes HTTP",value:95},{skill:"JWT (JSON Web Token)",value:85},{skill:"Réponses serveur (JSON et codes HTTP)",value:80}]}],colors:["rgb(25, 135, 84)","rgb(13, 202, 240)","rgb(255, 193, 7)"]},en:{title:"API for managing eco-development challenges in computing",description:"Creation and management of a MongoDB database using HTTP requests",sections:[{subtitle:"Context",paragraph:`As part of our NoSQL database courses, we had a month to create a 2-person API to communicate with. 
...
`,image:"/projets/api_defis/mongodb.jpg?url"},{subtitle:"Project Organization",paragraph:`For the database **(DB)** part, we went through MongoDB Compass to easily add data and visualize it to check its integrity throughout the development.
...
`,image:"/projets/api_defis/middleware.png?url"},{subtitle:"Technical Point : Error management",paragraph:`To try to have an API as close to reality as possible, we took the time to manage errors by providing the right codes depending on the situation.
...
`,image:"/projets/api_defis/testRequest.jpg?url"},{subtitle:"Feedback and Improvement points",paragraph:`I really enjoyed doing this project since it was the first time I created an API. I thus discovered MongoDB and its advantages such as easier access to data for simple queries (compared to SQL queries).  
